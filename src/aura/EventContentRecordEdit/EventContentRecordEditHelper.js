({
	...
	getEmptyRequiredFieldsList : function(component){
		...
		this.addField(component.get("v.titleRequired"), fields, $A.get("$Label.c.EventContentDetailTitle"), true, component.find("title"), null, null, content.Title);
		this.addField(component.get("v.extractRequired"), fields, $A.get("$Label.c.EventContentDetailExtract"), true, component.find("extract"), null, null, content.Extract);
		...
		this.addField(component.get("v.startDateRequired"), fields, $A.get("$Label.c.EventContentDetailEventStartDate"), true, component.find("startDate"), null, null, content.EventStartDate);
		this.addField(component.get("v.endDateRequired"), fields, $A.get("$Label.c.EventContentDetailEventEndDate"), true, component.find("endDate"), null, null, content.EventEndDate);
		this.addField(component.get("v.locationRequired"), fields, $A.get("$Label.c.EventContentDetailEventLocationInformation"), true, component.find("location"), null, null, content.Location);
		this.addField(component.get("v.featureRequired"), fields, $A.get("$Label.c.EventContentDetailFeatureImage"), false, null, component.find("featureDiv"), component.find("featureError"), component.get("v.imageUrl"));
		this.addField(component.get("v.layoutRequired"), fields, $A.get("$Label.c.EventContentDetailChooseLayout"), false, null, component.find("layoutDiv"), component.find("layoutError"), content.Layout);
